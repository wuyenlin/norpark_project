...
def args_parser():
    ...
    parser.add_argument('--train_img', type=str, default='CNRPark-Patches-150x150/', help="name of dataset")
    parser.add_argument('--train_lab', type=str, default='splits/CNRParkAB/even.txt', help="name of dataset")
    parser.add_argument('--test_img', type=str, default='CNRPark-Patches-150x150/', help="name of dataset")
    parser.add_argument('--test_lab', type=str, default='splits/CNRParkAB/odd.txt', help="name of dataset")
