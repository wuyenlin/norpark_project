...
def residual_standard_unit(n, nout, s, newdepth=False):
    ...
    """
    bottom = list(n.__dict__['tops'].keys())[-1]  # find the last layer in netspec
...
#        return n.to_proto()
    ...
    def body(self):
        ...
        assert self.layers in list(net_defs.keys()), 'net of depth:{} not defined'.format(self.layers)
        ...
        # add the end layers
        n.global_pool = L.Pooling(n.__dict__['tops'][list(n.__dict__['tops'].keys())[-1]],
